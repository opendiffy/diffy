  ...
  with MockitoSugar
{
  ...
  describe("Difference") {
    ...
    object j {
      val p =
        """
          ...
          |                "count": 203900,
          |                "step_conv_ratio": 1,
          |                "goal": "Viewed : Intro Carousel Screen",
          |                "overall_conv_ratio": 1,
          |                "avg_time": null,
          |                "event": "Viewed : Intro Carousel Screen"
          |              },
          |              {
          |                "count": 95100,
          |                "step_conv_ratio": 0.46640510053948014,
          |                "goal": "Viewed : Sign Up Screen",
          |                "overall_conv_ratio": 0.46640510053948014,
          |                "avg_time": 421556,
          |                "event": "Viewed : Sign Up Screen"
          |              },
          |              {
          |                "count": 6460,
          |                "step_conv_ratio": 0.06792849631966351,
          |                "goal": "Viewed : Dashboard",
          |                "overall_conv_ratio": 0.03168219715546837,
          |                "avg_time": 161478,
    ...
    it("should diff json correctly") {
      val p = JsonLifter.lift(JsonLifter.decode(j.p))
      val c = JsonLifter.lift(JsonLifter.decode(j.c))
      Difference(p,c) mustBe a [NoDifference[_]]
    }
  }
}
