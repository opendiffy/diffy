...
import ai.diffy.functional.functions.DecaFunction;
 ...
 * NamedEndpoint<Request9Out, Response9In>,
 * NamedEndpoint<Request10Out, Response10In>,
...
public interface DecaOperator<
        ...
        Request9Out, Response9In,
        Request10Out, Response10In,
        ResponseOut
        > extends DecaFunction<
                ...
                Function<Request9Out, Response9In>,
                Function<Request10Out, Response10In>,
